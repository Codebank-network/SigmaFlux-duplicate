...
api_key = st.secrets.get('api-key') or os.getenv('API_KEY')
if not api_key:
    st.error("API key not found. Add it to a .streamlit/secrets.toml file or set the API_KEY environment variable.")
    st.stop()
